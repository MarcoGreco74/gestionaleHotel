...
<form action="areaPreno.php" method='POST'>
...
Periodo-al :<input type="date" name="periodoOut" value="<?= $user['periodoOut'] ?>">
<span><?= $error['periodoOut'] ?></span></td></tr>
<tr><td>Tariffa :<input type="number" name="tariffa" value="<?= $user['tariffa'] ?>">
<span><?= $error['tariffa'] ?></span></td></tr>
<tr><td><input type="submit" name="invia" value="Crea prenotazione"></td></tr>
</form>
</table>
</div>
